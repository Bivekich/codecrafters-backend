...
const createTechnologiesRoutes = (db) => {
    ...
    router.post('/', async (req, res) => {
        try {
            const { title, name, description, isMain, group, image, mobileLines } = req.body;
            const newTechnology = { title, name, description: isMain ? description: null, isMain, group: !isMain ? group: null, image: isMain ? image: null, mobileLines: isMain ? mobileLines: null };
    ...
    router.put('/:id', async (req, res) => {
        try {
            const { title, name, description, isMain, group, image, mobileLines } = req.body;
            const updateData = { title, name, description: isMain ? description: null, isMain, group: !isMain ? group: null, image: isMain ? image: null, mobileLines: isMain ? mobileLines: null };
